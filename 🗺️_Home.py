...
# --- DIMENSIONS ---
innerWidth = streamlit_js_eval(js_expressions='window.width',  want_output = True, key = 'width')
innerHeight = streamlit_js_eval(js_expressions='window.height', want_output = True, key = 'height')
