...
st.markdown("""
    <style>
    .css-1jc7ptx, .e1ewe7hr3, .viewerBadge_container__1QSob, .styles_viewerBadge__1yB5_, .viewerBadge_link__1S137, .viewerBadge_text__1JaDK{ display: none; } #MainMenu{ visibility: hidden; } github { visibility: hidden; }footer { visibility: hidden; } header { visibility: True; }
    </style>
    """,
    unsafe_allow_html=True)
...
<style>
    div.block-container {padding-top: 0rem; padding-bottom: 0rem; padding-left: 0rem; padding-right: 0rem; margin-top: -4rem; margin-bottom: 0rem;}
</style>
"""
