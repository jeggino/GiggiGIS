...
INITIAL_VIEW_STATE = pdk.ViewState(latitude=gdf_areas.dissolve().centroid.x, longitude=gdf_areas.dissolve().centroid.y, zoom=11, max_zoom=16, pitch=45, bearing=0)
